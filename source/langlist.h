...
// Update
    ...
    STR_UPD_SELECTION,            // 317
    STR_UPD_BTN_ALL,
    STR_UPD_BTN_NONE,
    STR_UPD_BTN_THISPC,
    STR_UPD_BTN_THISPC_H,
    STR_UPD_BTN_NETWORK,          // 316
    STR_UPD_SELECTED,
    STR_UPD_TOTALSIZE,            // 310
    STR_UPD_TOTALAVAIL,           // 313

    STR_UPD_STREAMSTATS,          // 321
    STR_UPD_STREAM_STATE,
    STR_UPD_STREAM_COMPLETE,
    STR_UPD_STREAM_TIME,
    STR_UPD_STREAM_SESSDL,
    STR_UPD_STREAM_SESSUL,
    STR_UPD_STREAM_SEEDS,
    STR_UPD_STREAM_ALERT,
