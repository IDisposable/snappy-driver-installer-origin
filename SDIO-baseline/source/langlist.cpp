...
// Left panel
    ...
    DEF_STR("STR_UPDATES_BTN")
    DEF_STR("STR_UPDATES_BTN_H")
...
// Update
    ...
    DEF_STR("STR_UPD_SELECTED")
    DEF_STR("STR_UPD_TOTALSIZE")
    DEF_STR("STR_UPD_TOTALAVAIL")

    DEF_STR("STR_UPD_STREAMSTATS")
    DEF_STR("STR_UPD_STREAM_STATE")
    DEF_STR("STR_UPD_STREAM_COMPLETE")
    DEF_STR("STR_UPD_STREAM_TIME")
    DEF_STR("STR_UPD_STREAM_SESSDL")
    DEF_STR("STR_UPD_STREAM_SESSUL")
    DEF_STR("STR_UPD_STREAM_SEEDS")
    DEF_STR("STR_UPD_STREAM_ALERT")

    DEF_STR("STR_UPD_OPTIONS")
    DEF_STR("STR_UPD_ONLYUPDATES")
    DEF_STR("STR_UPD_KEEPSEEDING")

    DEF_STR("STR_UPD_SPECIALMODE")
    DEF_STR("STR_UPD_TXT_SHARE")
    DEF_STR("STR_UPD_BTN_SHARE")

    DEF_STR("STR_UPD_BTN_UPDATE")
    DEF_STR("STR_UPD_BTN_STOP")
    DEF_STR("STR_UPD_BTN_CLOSE")
...
// Update large prompt
    DEF_STR("STR_UPD_PROMPT_01")
    DEF_STR("STR_UPD_PROMPT_02")
    DEF_STR("STR_UPD_PROMPT_03")
    DEF_STR("STR_UPD_PROMPT_04")
    DEF_STR("STR_UPD_PROMPT_05")
    DEF_STR("STR_UPD_PROMPT_06")
    DEF_STR("STR_UPD_PROMPT_07")
    DEF_STR("STR_UPD_PROMPT_08")
    DEF_STR("STR_UPD_PROMPT_09")
    DEF_STR("STR_UPD_PROMPT_10")
    DEF_STR("STR_UPD_PROMPT_11")
...
// Update tab
    ...
    DEF_STR("STR_OPTION_TORRENTALERTS")
