...
| `gui.cpp`, `draw.cpp`, `theme*.cpp`, `welcome.cpp`, `usbwizard.cpp`, `license.cpp` | TUI (planned) | Not started | Replaced by a Bubble Tea TUI, not ported; `cmd/sdi`'s plain-text report is the interim front end. |
